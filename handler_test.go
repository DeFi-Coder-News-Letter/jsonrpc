...
type handler struct {
	F func(c context.Context, params *bijson.RawMessage) (interface{}, *Error)
}

func (h *handler) ServeJSONRPC(c context.Context, params *bijson.RawMessage) (interface{}, *Error) {
	return h.F(c, params)
}
...
func TestHandler(t *testing.T) {
	...
	res := Response{}
	err = bijson.NewDecoder(rec.Body).Decode(&res)
	require.NoError(t, err)
	...
	h1 := &handler{}
	h1.F = func(c context.Context, params *bijson.RawMessage) (interface{}, *Error) {
		return "hello", nil
	}
	require.NoError(t, mr.RegisterMethod("hello", h1, nil, nil))
	h2 := &handler{}
	h2.F = func(c context.Context, params *bijson.RawMessage) (interface{}, *Error) {
