...
func (h EchoHandler) ServeJSONRPC(c context.Context, params *bijson.RawMessage) (interface{}, *Error) {
...
func (h PositionalHandler) ServeJSONRPC(c context.Context, params *bijson.RawMessage) (interface{}, *Error) {
